...
Este repositório contém uma solução completa de **Engenharia de Analytics** desenvolvida para a gestão de dados de check-ins e repasses financeiros da rede **WeFitness**. O projeto simula o fluxo real de dados entre uma plataforma de benefícios (estilo TotalPass) e suas academias parceiras.
